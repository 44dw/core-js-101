...
//     const result = [];
//     arr.forEach(async (p) => {
//       await p.then((val) => result.push(val))
//         .catch((e) => console.error(e));
//     });
//     return result;
//   }

//   const res = await all(array);
//   return res.reduce(action, 0);
// }

// chainPromises([Promise.resolve(1), Promise.reject('err'), Promise.resolve(3)], (a, b) => a + b)
